...
(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { let g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.less = f() } })(function () {
    ...
    //
      ...
      module.exports = function (window, options) {
        ...
        less.refresh = function (reload, modifyVars, clearFileCache) {
          ...
          return new Promise(function (resolve, reject) {
            let startTime, endTime, totalMilliseconds, remainingSheets
 ...
 */
    ...
    31: [function (require, module, exports) {
      module.exports = function (environment, fileManagers) {
        let SourceMapOutput, SourceMapBuilder, ParseTree, ImportManager, Environment
      ...
      const Parser = function Parser (context, imports, fileInfo) {
        ...
        return {
          ...
          parsers: parsers = {
            ...
            entities: {
              ...
              parserInput.$re(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/) || ''
                ...
                return new (tree.URL)((value.value != null || value instanceof tree.Variable)
                  ? value
                  : new (tree.Anonymous)(value), index, fileInfo)
              },
            ...
            //
            ruleset: function () {
              let selectors, s, rules, debugInfo
